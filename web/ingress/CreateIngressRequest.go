...
func CreateIngressRequest(c *fiber.Ctx) error {
	var dto CreateIngressRequestDto
	...
	secret, err := client.CreateIngress(dto.Namespace, &v1.Ingress{
		Spec: dto.IngressSpec,
	})
